...
{
    public class ScriptUserControlViewModel : ViewModelBase
    {
        /// <summary>
        /// 构造函数
        /// </summary>
        ...
        {
            Model = new ScriptUserControlModel() { };
        }


        private ScriptUserControlModel model;
            /// <summary>
            /// 欢迎词属性
            /// </summary>
            public ScriptUserControlModel Model
            {
                get { return model; }
