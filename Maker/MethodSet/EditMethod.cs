...
namespace Maker.MethodSet
{
    public static class EditMethod
    {
        ...
        public static List<Light> EditMain(String commandLine, List<Light> lightGroup, Dictionary<String, List<int>> rangeGroupDictionary, Dictionary<String, List<int>> colorGroupDictionary,List<ThirdPartyModel> thirdPartyModelList)
        {
            ...
            Regex P_HorizontalFlipping = new Regex(@"\s*HorizontalFlipping\([0-9a-zA-Z_\u4e00-\u9fa5]{1,}\)");
            if (P_HorizontalFlipping.IsMatch(commandLine))
            {
                return HorizontalFlipping(_lightGroup);
            }
            Regex P_VerticalFlipping = new Regex(@"\s*VerticalFlipping\([0-9a-zA-Z_\u4e00-\u9fa5]{1,}\)");
            if (P_VerticalFlipping.IsMatch(commandLine))
            {
                return VerticalFlipping(_lightGroup);
            }
            Regex P_LowerLeftSlashFlipping = new Regex(@"\s*LowerLeftSlashFlipping\([0-9a-zA-Z_\u4e00-\u9fa5]{1,}\)");
            if (P_LowerLeftSlashFlipping.IsMatch(commandLine))
            {
                return LowerLeftSlashFlipping(_lightGroup);
            }
            Regex P_LowerRightSlashFlipping = new Regex(@"\s*LowerRightSlashFlipping\([0-9a-zA-Z_\u4e00-\u9fa5]{1,}\)");
            if (P_LowerRightSlashFlipping.IsMatch(commandLine))
            {
                return LowerRightSlashFlipping(_lightGroup);
            }
        ...
        private static List<Light> LowerRightSlashFlipping(List<Light> lightGroup)
        {
            #region
            for (int k = 0; k < lightGroup.Count; k++)
            {
                //左下
                if (lightGroup[k].Position == 36) { lightGroup[k].Position = 99; continue; }
                if (lightGroup[k].Position == 37) { lightGroup[k].Position = 95; continue; }
                if (lightGroup[k].Position == 38) { lightGroup[k].Position = 91; continue; }
                if (lightGroup[k].Position == 39) { lightGroup[k].Position = 87; continue; }

                if (lightGroup[k].Position == 40) { lightGroup[k].Position = 98; continue; }
                if (lightGroup[k].Position == 41) { lightGroup[k].Position = 94; continue; }
                if (lightGroup[k].Position == 42) { lightGroup[k].Position = 90; continue; }
                if (lightGroup[k].Position == 43) { lightGroup[k].Position = 86; continue; }

                if (lightGroup[k].Position == 44) { lightGroup[k].Position = 97; continue; }
                if (lightGroup[k].Position == 45) { lightGroup[k].Position = 93; continue; }
                if (lightGroup[k].Position == 46) { lightGroup[k].Position = 89; continue; }
                if (lightGroup[k].Position == 47) { lightGroup[k].Position = 85; continue; }

                if (lightGroup[k].Position == 48) { lightGroup[k].Position = 96; continue; }
                if (lightGroup[k].Position == 49) { lightGroup[k].Position = 92; continue; }
                if (lightGroup[k].Position == 50) { lightGroup[k].Position = 88; continue; }
                if (lightGroup[k].Position == 51) { lightGroup[k].Position = 84; continue; }

                //左上
                if (lightGroup[k].Position == 52) { lightGroup[k].Position = 67; continue; }
                if (lightGroup[k].Position == 53) { lightGroup[k].Position = 63; continue; }
                if (lightGroup[k].Position == 54) { lightGroup[k].Position = 59; continue; }
                if (lightGroup[k].Position == 55) { continue; }

                if (lightGroup[k].Position == 56) { lightGroup[k].Position = 66; continue; }
                if (lightGroup[k].Position == 57) { lightGroup[k].Position = 62; continue; }
                if (lightGroup[k].Position == 58) { continue; }
                if (lightGroup[k].Position == 59) { lightGroup[k].Position = 54; continue; }

                if (lightGroup[k].Position == 60) { lightGroup[k].Position = 65; continue; }
                if (lightGroup[k].Position == 61) { continue; }
                if (lightGroup[k].Position == 62) { lightGroup[k].Position = 57; continue; }
                if (lightGroup[k].Position == 63) { lightGroup[k].Position = 53; continue; }

                if (lightGroup[k].Position == 64) { continue; }
                if (lightGroup[k].Position == 65) { lightGroup[k].Position = 60; continue; }
                if (lightGroup[k].Position == 66) { lightGroup[k].Position = 56; continue; }
                if (lightGroup[k].Position == 67) { lightGroup[k].Position = 52; continue; }

                //右下
                if (lightGroup[k].Position == 68) { lightGroup[k].Position = 83; continue; }
                if (lightGroup[k].Position == 69) { lightGroup[k].Position = 79; continue; }
                if (lightGroup[k].Position == 70) { lightGroup[k].Position = 75; continue; }
                if (lightGroup[k].Position == 71) { continue; }

                if (lightGroup[k].Position == 72) { lightGroup[k].Position = 82; continue; }
                if (lightGroup[k].Position == 73) { lightGroup[k].Position = 78; continue; }
                if (lightGroup[k].Position == 74) { continue; }
                if (lightGroup[k].Position == 75) { lightGroup[k].Position = 70; continue; }

                if (lightGroup[k].Position == 76) { lightGroup[k].Position = 81; continue; }
                if (lightGroup[k].Position == 77) { lightGroup[k].Position = 46; continue; }
                if (lightGroup[k].Position == 78) { continue; }
                if (lightGroup[k].Position == 79) { lightGroup[k].Position = 69; continue; }

                if (lightGroup[k].Position == 80) { continue; }
                if (lightGroup[k].Position == 81) { lightGroup[k].Position = 76; continue; }
                if (lightGroup[k].Position == 82) { lightGroup[k].Position = 72; continue; }
                if (lightGroup[k].Position == 83) { lightGroup[k].Position = 68; continue; }

                //右上
                if (lightGroup[k].Position == 84) { lightGroup[k].Position = 51; continue; }
                if (lightGroup[k].Position == 85) { lightGroup[k].Position = 47; continue; }
                if (lightGroup[k].Position == 86) { lightGroup[k].Position = 43; continue; }
                if (lightGroup[k].Position == 87) { lightGroup[k].Position = 39; continue; }

                if (lightGroup[k].Position == 88) { lightGroup[k].Position = 50; continue; }
                if (lightGroup[k].Position == 89) { lightGroup[k].Position = 46; continue; }
                if (lightGroup[k].Position == 90) { lightGroup[k].Position = 42; continue; }
                if (lightGroup[k].Position == 91) { lightGroup[k].Position = 38; continue; }

                if (lightGroup[k].Position == 92) { lightGroup[k].Position = 49; continue; }
                if (lightGroup[k].Position == 93) { lightGroup[k].Position = 45; continue; }
                if (lightGroup[k].Position == 94) { lightGroup[k].Position = 41; continue; }
                if (lightGroup[k].Position == 95) { lightGroup[k].Position = 37; continue; }

                if (lightGroup[k].Position == 96) { lightGroup[k].Position = 48; continue; }
                if (lightGroup[k].Position == 97) { lightGroup[k].Position = 44; continue; }
                if (lightGroup[k].Position == 98) { lightGroup[k].Position = 40; continue; }
                if (lightGroup[k].Position == 99) { lightGroup[k].Position = 36; continue; }

                //右圆钮
                if (lightGroup[k].Position == 100) { lightGroup[k].Position = 116; continue; }
                if (lightGroup[k].Position == 101) { lightGroup[k].Position = 117; continue; }
                if (lightGroup[k].Position == 102) { lightGroup[k].Position = 118; continue; }
                if (lightGroup[k].Position == 103) { lightGroup[k].Position = 119; continue; }
                if (lightGroup[k].Position == 104) { lightGroup[k].Position = 120; continue; }
                if (lightGroup[k].Position == 105) { lightGroup[k].Position = 121; continue; }
                if (lightGroup[k].Position == 106) { lightGroup[k].Position = 122; continue; }
                if (lightGroup[k].Position == 107) { lightGroup[k].Position = 123; continue; }

                //左圆钮
                if (lightGroup[k].Position == 108) { lightGroup[k].Position = 28; continue; }
                if (lightGroup[k].Position == 109) { lightGroup[k].Position = 29; continue; }
                if (lightGroup[k].Position == 110) { lightGroup[k].Position = 30; continue; }
                if (lightGroup[k].Position == 111) { lightGroup[k].Position = 31; continue; }
                if (lightGroup[k].Position == 112) { lightGroup[k].Position = 32; continue; }
                if (lightGroup[k].Position == 113) { lightGroup[k].Position = 33; continue; }
                if (lightGroup[k].Position == 114) { lightGroup[k].Position = 34; continue; }
                if (lightGroup[k].Position == 115) { lightGroup[k].Position = 35; continue; }

                //下圆钮
                if (lightGroup[k].Position == 116) { lightGroup[k].Position = 100; continue; }
                if (lightGroup[k].Position == 117) { lightGroup[k].Position = 101; continue; }
                if (lightGroup[k].Position == 118) { lightGroup[k].Position = 102; continue; }
                if (lightGroup[k].Position == 119) { lightGroup[k].Position = 103; continue; }
                if (lightGroup[k].Position == 120) { lightGroup[k].Position = 104; continue; }
                if (lightGroup[k].Position == 121) { lightGroup[k].Position = 105; continue; }
                if (lightGroup[k].Position == 122) { lightGroup[k].Position = 106; continue; }
                if (lightGroup[k].Position == 123) { lightGroup[k].Position = 107; continue; }

                //上圆钮
                if (lightGroup[k].Position == 28) { lightGroup[k].Position = 108; continue; }
                if (lightGroup[k].Position == 29) { lightGroup[k].Position = 109; continue; }
                if (lightGroup[k].Position == 30) { lightGroup[k].Position = 110; continue; }
                if (lightGroup[k].Position == 31) { lightGroup[k].Position = 111; continue; }
                if (lightGroup[k].Position == 32) { lightGroup[k].Position = 112; continue; }
                if (lightGroup[k].Position == 33) { lightGroup[k].Position = 113; continue; }
                if (lightGroup[k].Position == 34) { lightGroup[k].Position = 114; continue; }
                if (lightGroup[k].Position == 35) { lightGroup[k].Position = 115; continue; }
            }
            #endregion
            return lightGroup;
        }

        private static List<Light> LowerLeftSlashFlipping(List<Light> lightGroup)
        {
            #region
            for (int k = 0; k < lightGroup.Count; k++)
            {
                //左下
                if (lightGroup[k].Position == 36) { continue; }
                if (lightGroup[k].Position == 37) { lightGroup[k].Position = 40; continue; }
                if (lightGroup[k].Position == 38) { lightGroup[k].Position = 44; continue; }
                if (lightGroup[k].Position == 39) { lightGroup[k].Position = 48; continue; }

                if (lightGroup[k].Position == 40) { lightGroup[k].Position = 37; continue; }
                if (lightGroup[k].Position == 41) { continue; }
                if (lightGroup[k].Position == 42) { lightGroup[k].Position = 45; continue; }
                if (lightGroup[k].Position == 43) { lightGroup[k].Position = 49; continue; }

                if (lightGroup[k].Position == 44) { lightGroup[k].Position = 38; continue; }
                if (lightGroup[k].Position == 45) { lightGroup[k].Position = 42; continue; }
                if (lightGroup[k].Position == 46) { continue; }
                if (lightGroup[k].Position == 47) { lightGroup[k].Position = 50; continue; }

                if (lightGroup[k].Position == 48) { lightGroup[k].Position = 39; continue; }
                if (lightGroup[k].Position == 49) { lightGroup[k].Position = 43; continue; }
                if (lightGroup[k].Position == 50) { lightGroup[k].Position = 47; continue; }
                if (lightGroup[k].Position == 51) { continue; }

                //左上
                if (lightGroup[k].Position == 68) { lightGroup[k].Position = 52; continue; }
                if (lightGroup[k].Position == 69) { lightGroup[k].Position = 56; continue; }
                if (lightGroup[k].Position == 70) { lightGroup[k].Position = 60; continue; }
                if (lightGroup[k].Position == 71) { lightGroup[k].Position = 64; continue; }

                if (lightGroup[k].Position == 72) { lightGroup[k].Position = 53; continue; }
                if (lightGroup[k].Position == 73) { lightGroup[k].Position = 57; continue; }
                if (lightGroup[k].Position == 74) { lightGroup[k].Position = 61; continue; }
                if (lightGroup[k].Position == 75) { lightGroup[k].Position = 65; continue; }

                if (lightGroup[k].Position == 76) { lightGroup[k].Position = 54; continue; }
                if (lightGroup[k].Position == 77) { lightGroup[k].Position = 58; continue; }
                if (lightGroup[k].Position == 78) { lightGroup[k].Position = 62; continue; }
                if (lightGroup[k].Position == 79) { lightGroup[k].Position = 66; continue; }

                if (lightGroup[k].Position == 80) { lightGroup[k].Position = 55; continue; }
                if (lightGroup[k].Position == 81) { lightGroup[k].Position = 59; continue; }
                if (lightGroup[k].Position == 82) { lightGroup[k].Position = 63; continue; }
                if (lightGroup[k].Position == 83) { lightGroup[k].Position = 67; continue; }
                //右下
                if (lightGroup[k].Position == 52) { lightGroup[k].Position = 68; continue; }
                if (lightGroup[k].Position == 53) { lightGroup[k].Position = 72; continue; }
                if (lightGroup[k].Position == 54) { lightGroup[k].Position = 76; continue; }
                if (lightGroup[k].Position == 55) { lightGroup[k].Position = 80; continue; }

                if (lightGroup[k].Position == 56) { lightGroup[k].Position = 69; continue; }
                if (lightGroup[k].Position == 57) { lightGroup[k].Position = 73; continue; }
                if (lightGroup[k].Position == 58) { lightGroup[k].Position = 77; continue; }
                if (lightGroup[k].Position == 59) { lightGroup[k].Position = 81; continue; }

                if (lightGroup[k].Position == 60) { lightGroup[k].Position = 70; continue; }
                if (lightGroup[k].Position == 61) { lightGroup[k].Position = 74; continue; }
                if (lightGroup[k].Position == 62) { lightGroup[k].Position = 78; continue; }
                if (lightGroup[k].Position == 63) { lightGroup[k].Position = 82; continue; }

                if (lightGroup[k].Position == 64) { lightGroup[k].Position = 71; continue; }
                if (lightGroup[k].Position == 65) { lightGroup[k].Position = 75; continue; }
                if (lightGroup[k].Position == 66) { lightGroup[k].Position = 79; continue; }
                if (lightGroup[k].Position == 67) { lightGroup[k].Position = 83; continue; }
                //右上
                if (lightGroup[k].Position == 84) { continue; }
                if (lightGroup[k].Position == 85) { lightGroup[k].Position = 88; continue; }
                if (lightGroup[k].Position == 86) { lightGroup[k].Position = 92; continue; }
                if (lightGroup[k].Position == 87) { lightGroup[k].Position = 96; continue; }

                if (lightGroup[k].Position == 88) { lightGroup[k].Position = 85; continue; }
                if (lightGroup[k].Position == 89) { continue; }
                if (lightGroup[k].Position == 90) { lightGroup[k].Position = 93; continue; }
                if (lightGroup[k].Position == 91) { lightGroup[k].Position = 97; continue; }

                if (lightGroup[k].Position == 92) { lightGroup[k].Position = 86; continue; }
                if (lightGroup[k].Position == 93) { lightGroup[k].Position = 90; continue; }
                if (lightGroup[k].Position == 94) { continue; }
                if (lightGroup[k].Position == 95) { lightGroup[k].Position = 98; continue; }

                if (lightGroup[k].Position == 96) { lightGroup[k].Position = 87; continue; }
                if (lightGroup[k].Position == 97) { lightGroup[k].Position = 91; continue; }
                if (lightGroup[k].Position == 98) { lightGroup[k].Position = 95; continue; }
                if (lightGroup[k].Position == 99) { continue; }

                //右圆钮
                if (lightGroup[k].Position == 100) { lightGroup[k].Position = 35; continue; }
                if (lightGroup[k].Position == 101) { lightGroup[k].Position = 34; continue; }
                if (lightGroup[k].Position == 102) { lightGroup[k].Position = 33; continue; }
                if (lightGroup[k].Position == 103) { lightGroup[k].Position = 32; continue; }
                if (lightGroup[k].Position == 104) { lightGroup[k].Position = 31; continue; }
                if (lightGroup[k].Position == 105) { lightGroup[k].Position = 30; continue; }
                if (lightGroup[k].Position == 106) { lightGroup[k].Position = 29; continue; }
                if (lightGroup[k].Position == 107) { lightGroup[k].Position = 28; continue; }

                //左圆钮
                if (lightGroup[k].Position == 108) { lightGroup[k].Position = 123; continue; }
                if (lightGroup[k].Position == 109) { lightGroup[k].Position = 122; continue; }
                if (lightGroup[k].Position == 110) { lightGroup[k].Position = 121; continue; }
                if (lightGroup[k].Position == 111) { lightGroup[k].Position = 120; continue; }
                if (lightGroup[k].Position == 112) { lightGroup[k].Position = 119; continue; }
                if (lightGroup[k].Position == 113) { lightGroup[k].Position = 118; continue; }
                if (lightGroup[k].Position == 114) { lightGroup[k].Position = 117; continue; }
                if (lightGroup[k].Position == 115) { lightGroup[k].Position = 116; continue; }

                //下圆钮
                if (lightGroup[k].Position == 116) { lightGroup[k].Position = 115; continue; }
                if (lightGroup[k].Position == 117) { lightGroup[k].Position = 114; continue; }
                if (lightGroup[k].Position == 118) { lightGroup[k].Position = 113; continue; }
                if (lightGroup[k].Position == 119) { lightGroup[k].Position = 112; continue; }
                if (lightGroup[k].Position == 120) { lightGroup[k].Position = 111; continue; }
                if (lightGroup[k].Position == 121) { lightGroup[k].Position = 110; continue; }
                if (lightGroup[k].Position == 122) { lightGroup[k].Position = 109; continue; }
                if (lightGroup[k].Position == 123) { lightGroup[k].Position = 108; continue; }

                //上圆钮
                if (lightGroup[k].Position == 28) { lightGroup[k].Position = 107; continue; }
                if (lightGroup[k].Position == 29) { lightGroup[k].Position = 106; continue; }
                if (lightGroup[k].Position == 30) { lightGroup[k].Position = 105; continue; }
                if (lightGroup[k].Position == 31) { lightGroup[k].Position = 104; continue; }
                if (lightGroup[k].Position == 32) { lightGroup[k].Position = 103; continue; }
                if (lightGroup[k].Position == 33) { lightGroup[k].Position = 102; continue; }
                if (lightGroup[k].Position == 34) { lightGroup[k].Position = 101; continue; }
                if (lightGroup[k].Position == 35) { lightGroup[k].Position = 100; continue; }
            }
            #endregion
            return lightGroup;
        }
       ...
       private static List<Light> Windmill(List<Light> lightGroup, int interval)
        ...
        /// <param name="lightGroup"></param>
        /// <returns></returns>
        public static List<Light> HorizontalFlipping(List<Light> lightGroup)
        {
            #region
            for (int k = 0; k < lightGroup.Count; k++)
            {
                ...
                if (lightGroup[k].Position == 37) { lightGroup[k].Position = 65; continue; }
                if (lightGroup[k].Position == 38) { lightGroup[k].Position = 66; continue; }
                if (lightGroup[k].Position == 39) { lightGroup[k].Position = 67; continue; }

                if (lightGroup[k].Position == 40) { lightGroup[k].Position = 60; continue; }
                if (lightGroup[k].Position == 41) { lightGroup[k].Position = 61; continue; }
                if (lightGroup[k].Position == 42) { lightGroup[k].Position = 62; continue; }
                if (lightGroup[k].Position == 43) { lightGroup[k].Position = 63; continue; }

                if (lightGroup[k].Position == 44) { lightGroup[k].Position = 56; continue; }
                if (lightGroup[k].Position == 45) { lightGroup[k].Position = 57; continue; }
                if (lightGroup[k].Position == 46) { lightGroup[k].Position = 58; continue; }
                if (lightGroup[k].Position == 47) { lightGroup[k].Position = 59; continue; }

                if (lightGroup[k].Position == 48) { lightGroup[k].Position = 52; continue; }
                if (lightGroup[k].Position == 49) { lightGroup[k].Position = 53; continue; }
                if (lightGroup[k].Position == 50) { lightGroup[k].Position = 54; continue; }
                if (lightGroup[k].Position == 51) { lightGroup[k].Position = 55; continue; }

                //左上
                if (lightGroup[k].Position == 52) { lightGroup[k].Position = 48; continue; }
                if (lightGroup[k].Position == 53) { lightGroup[k].Position = 49; continue; }
                if (lightGroup[k].Position == 54) { lightGroup[k].Position = 50; continue; }
                if (lightGroup[k].Position == 55) { lightGroup[k].Position = 51; continue; }

                if (lightGroup[k].Position == 56) { lightGroup[k].Position = 44; continue; }
                if (lightGroup[k].Position == 57) { lightGroup[k].Position = 45; continue; }
                if (lightGroup[k].Position == 58) { lightGroup[k].Position = 46; continue; }
                if (lightGroup[k].Position == 59) { lightGroup[k].Position = 47; continue; }

                if (lightGroup[k].Position == 60) { lightGroup[k].Position = 40; continue; }
                if (lightGroup[k].Position == 61) { lightGroup[k].Position = 41; continue; }
                if (lightGroup[k].Position == 62) { lightGroup[k].Position = 42; continue; }
                if (lightGroup[k].Position == 63) { lightGroup[k].Position = 43; continue; }

                if (lightGroup[k].Position == 64) { lightGroup[k].Position = 36; continue; }
                if (lightGroup[k].Position == 65) { lightGroup[k].Position = 37; continue; }
                if (lightGroup[k].Position == 66) { lightGroup[k].Position = 38; continue; }
                if (lightGroup[k].Position == 67) { lightGroup[k].Position = 39; continue; }

                //右下
                if (lightGroup[k].Position == 68) { lightGroup[k].Position = 96; continue; }
                if (lightGroup[k].Position == 69) { lightGroup[k].Position = 97; continue; }
                if (lightGroup[k].Position == 70) { lightGroup[k].Position = 98; continue; }
                if (lightGroup[k].Position == 71) { lightGroup[k].Position = 99; continue; }

                if (lightGroup[k].Position == 72) { lightGroup[k].Position = 92; continue; }
                if (lightGroup[k].Position == 73) { lightGroup[k].Position = 93; continue; }
                if (lightGroup[k].Position == 74) { lightGroup[k].Position = 94; continue; }
                if (lightGroup[k].Position == 75) { lightGroup[k].Position = 95; continue; }

                if (lightGroup[k].Position == 76) { lightGroup[k].Position = 88; continue; }
                if (lightGroup[k].Position == 77) { lightGroup[k].Position = 89; continue; }
                if (lightGroup[k].Position == 78) { lightGroup[k].Position = 90; continue; }
                if (lightGroup[k].Position == 79) { lightGroup[k].Position = 91; continue; }

                if (lightGroup[k].Position == 80) { lightGroup[k].Position = 84; continue; }
                if (lightGroup[k].Position == 81) { lightGroup[k].Position = 85; continue; }
                if (lightGroup[k].Position == 82) { lightGroup[k].Position = 86; continue; }
                if (lightGroup[k].Position == 83) { lightGroup[k].Position = 87; continue; }

                //右上
                if (lightGroup[k].Position == 84) { lightGroup[k].Position = 80; continue; }
                if (lightGroup[k].Position == 85) { lightGroup[k].Position = 81; continue; }
                if (lightGroup[k].Position == 86) { lightGroup[k].Position = 82; continue; }
                if (lightGroup[k].Position == 87) { lightGroup[k].Position = 83; continue; }

                if (lightGroup[k].Position == 88) { lightGroup[k].Position = 76; continue; }
                if (lightGroup[k].Position == 89) { lightGroup[k].Position = 77; continue; }
                if (lightGroup[k].Position == 90) { lightGroup[k].Position = 78; continue; }
                if (lightGroup[k].Position == 91) { lightGroup[k].Position = 79; continue; }

                if (lightGroup[k].Position == 92) { lightGroup[k].Position = 72; continue; }
                if (lightGroup[k].Position == 93) { lightGroup[k].Position = 73; continue; }
                if (lightGroup[k].Position == 94) { lightGroup[k].Position = 74; continue; }
                if (lightGroup[k].Position == 95) { lightGroup[k].Position = 75; continue; }

                if (lightGroup[k].Position == 96) { lightGroup[k].Position = 68; continue; }
                if (lightGroup[k].Position == 97) { lightGroup[k].Position = 69; continue; }
                if (lightGroup[k].Position == 98) { lightGroup[k].Position = 70; continue; }
                if (lightGroup[k].Position == 99) { lightGroup[k].Position = 71; continue; }

                //右圆钮
                if (lightGroup[k].Position == 100) { lightGroup[k].Position = 107; continue; }
                if (lightGroup[k].Position == 101) { lightGroup[k].Position = 106; continue; }
                if (lightGroup[k].Position == 102) { lightGroup[k].Position = 105; continue; }
                if (lightGroup[k].Position == 103) { lightGroup[k].Position = 104; continue; }
                if (lightGroup[k].Position == 104) { lightGroup[k].Position = 103; continue; }
                if (lightGroup[k].Position == 105) { lightGroup[k].Position = 102; continue; }
                if (lightGroup[k].Position == 106) { lightGroup[k].Position = 101; continue; }
                if (lightGroup[k].Position == 107) { lightGroup[k].Position = 100; continue; }

                //左圆钮
                if (lightGroup[k].Position == 108) { lightGroup[k].Position = 115; continue; }
                if (lightGroup[k].Position == 109) { lightGroup[k].Position = 114; continue; }
                if (lightGroup[k].Position == 110) { lightGroup[k].Position = 113; continue; }
                if (lightGroup[k].Position == 111) { lightGroup[k].Position = 112; continue; }
                if (lightGroup[k].Position == 112) { lightGroup[k].Position = 111; continue; }
                if (lightGroup[k].Position == 113) { lightGroup[k].Position = 110; continue; }
                if (lightGroup[k].Position == 114) { lightGroup[k].Position = 109; continue; }
                if (lightGroup[k].Position == 115) { lightGroup[k].Position = 108; continue; }

                //下圆钮
                if (lightGroup[k].Position == 116) { lightGroup[k].Position = 28; continue; }
                if (lightGroup[k].Position == 117) { lightGroup[k].Position = 29; continue; }
                if (lightGroup[k].Position == 118) { lightGroup[k].Position = 30; continue; }
                if (lightGroup[k].Position == 119) { lightGroup[k].Position = 31; continue; }
                if (lightGroup[k].Position == 120) { lightGroup[k].Position = 32; continue; }
                if (lightGroup[k].Position == 121) { lightGroup[k].Position = 33; continue; }
                if (lightGroup[k].Position == 122) { lightGroup[k].Position = 34; continue; }
                if (lightGroup[k].Position == 123) { lightGroup[k].Position = 35; continue; }

                //上圆钮
                if (lightGroup[k].Position == 28) { lightGroup[k].Position = 116; continue; }
                if (lightGroup[k].Position == 29) { lightGroup[k].Position = 117; continue; }
                if (lightGroup[k].Position == 30) { lightGroup[k].Position = 118; continue; }
                if (lightGroup[k].Position == 31) { lightGroup[k].Position = 119; continue; }
                if (lightGroup[k].Position == 32) { lightGroup[k].Position = 120; continue; }
                if (lightGroup[k].Position == 33) { lightGroup[k].Position = 121; continue; }
                if (lightGroup[k].Position == 34) { lightGroup[k].Position = 122; continue; }
                if (lightGroup[k].Position == 35) { lightGroup[k].Position = 123; continue; }
            }
            #endregion
            return lightGroup;
        }
        ...
        /// <param name="lightGroup"></param>
        /// <returns></returns>
        public static List<Light> VerticalFlipping(List<Light> lightGroup)
        {
            #region
            for (int k = 0; k < lightGroup.Count; k++)
            {
                ...
                if (lightGroup[k].Position == 37) { lightGroup[k].Position = 70; continue; }
                if (lightGroup[k].Position == 38) { lightGroup[k].Position = 69; continue; }
                if (lightGroup[k].Position == 39) { lightGroup[k].Position = 68; continue; }

                if (lightGroup[k].Position == 40) { lightGroup[k].Position = 75; continue; }
                if (lightGroup[k].Position == 41) { lightGroup[k].Position = 74; continue; }
                if (lightGroup[k].Position == 42) { lightGroup[k].Position = 73; continue; }
                if (lightGroup[k].Position == 43) { lightGroup[k].Position = 72; continue; }

                if (lightGroup[k].Position == 44) { lightGroup[k].Position = 79; continue; }
                if (lightGroup[k].Position == 45) { lightGroup[k].Position = 78; continue; }
                if (lightGroup[k].Position == 46) { lightGroup[k].Position = 77; continue; }
                if (lightGroup[k].Position == 47) { lightGroup[k].Position = 76; continue; }

                if (lightGroup[k].Position == 48) { lightGroup[k].Position = 83; continue; }
                if (lightGroup[k].Position == 49) { lightGroup[k].Position = 82; continue; }
                if (lightGroup[k].Position == 50) { lightGroup[k].Position = 81; continue; }
                if (lightGroup[k].Position == 51) { lightGroup[k].Position = 80; continue; }

                //左上
                if (lightGroup[k].Position == 52) { lightGroup[k].Position = 87; continue; }
                if (lightGroup[k].Position == 53) { lightGroup[k].Position = 86; continue; }
                if (lightGroup[k].Position == 54) { lightGroup[k].Position = 85; continue; }
                if (lightGroup[k].Position == 55) { lightGroup[k].Position = 84; continue; }

                if (lightGroup[k].Position == 56) { lightGroup[k].Position = 91; continue; }
                if (lightGroup[k].Position == 57) { lightGroup[k].Position = 90; continue; }
                if (lightGroup[k].Position == 58) { lightGroup[k].Position = 89; continue; }
                if (lightGroup[k].Position == 59) { lightGroup[k].Position = 88; continue; }

                if (lightGroup[k].Position == 60) { lightGroup[k].Position = 95; continue; }
                if (lightGroup[k].Position == 61) { lightGroup[k].Position = 94; continue; }
                if (lightGroup[k].Position == 62) { lightGroup[k].Position = 93; continue; }
                if (lightGroup[k].Position == 63) { lightGroup[k].Position = 92; continue; }

                if (lightGroup[k].Position == 64) { lightGroup[k].Position = 99; continue; }
                if (lightGroup[k].Position == 65) { lightGroup[k].Position = 98; continue; }
                if (lightGroup[k].Position == 66) { lightGroup[k].Position = 97; continue; }
                if (lightGroup[k].Position == 67) { lightGroup[k].Position = 96; continue; }

                //右下
                if (lightGroup[k].Position == 68) { lightGroup[k].Position = 39; continue; }
                if (lightGroup[k].Position == 69) { lightGroup[k].Position = 38; continue; }
                if (lightGroup[k].Position == 70) { lightGroup[k].Position = 37; continue; }
                if (lightGroup[k].Position == 71) { lightGroup[k].Position = 36; continue; }

                if (lightGroup[k].Position == 72) { lightGroup[k].Position = 43; continue; }
                if (lightGroup[k].Position == 73) { lightGroup[k].Position = 42; continue; }
                if (lightGroup[k].Position == 74) { lightGroup[k].Position = 41; continue; }
                if (lightGroup[k].Position == 75) { lightGroup[k].Position = 40; continue; }

                if (lightGroup[k].Position == 76) { lightGroup[k].Position = 47; continue; }
                if (lightGroup[k].Position == 77) { lightGroup[k].Position = 46; continue; }
                if (lightGroup[k].Position == 78) { lightGroup[k].Position = 45; continue; }
                if (lightGroup[k].Position == 79) { lightGroup[k].Position = 44; continue; }

                if (lightGroup[k].Position == 80) { lightGroup[k].Position = 51; continue; }
                if (lightGroup[k].Position == 81) { lightGroup[k].Position = 50; continue; }
                if (lightGroup[k].Position == 82) { lightGroup[k].Position = 49; continue; }
                if (lightGroup[k].Position == 83) { lightGroup[k].Position = 48; continue; }

                //右上
                if (lightGroup[k].Position == 84) { lightGroup[k].Position = 55; continue; }
                if (lightGroup[k].Position == 85) { lightGroup[k].Position = 54; continue; }
                if (lightGroup[k].Position == 86) { lightGroup[k].Position = 53; continue; }
                if (lightGroup[k].Position == 87) { lightGroup[k].Position = 52; continue; }

                if (lightGroup[k].Position == 88) { lightGroup[k].Position = 59; continue; }
                if (lightGroup[k].Position == 89) { lightGroup[k].Position = 58; continue; }
                if (lightGroup[k].Position == 90) { lightGroup[k].Position = 57; continue; }
                if (lightGroup[k].Position == 91) { lightGroup[k].Position = 56; continue; }

                if (lightGroup[k].Position == 92) { lightGroup[k].Position = 63; continue; }
                if (lightGroup[k].Position == 93) { lightGroup[k].Position = 62; continue; }
                if (lightGroup[k].Position == 94) { lightGroup[k].Position = 61; continue; }
                if (lightGroup[k].Position == 95) { lightGroup[k].Position = 60; continue; }

                if (lightGroup[k].Position == 96) { lightGroup[k].Position = 67; continue; }
                if (lightGroup[k].Position == 97) { lightGroup[k].Position = 66; continue; }
                if (lightGroup[k].Position == 98) { lightGroup[k].Position = 65; continue; }
                if (lightGroup[k].Position == 99) { lightGroup[k].Position = 64; continue; }

                //右圆钮
                if (lightGroup[k].Position == 100) { lightGroup[k].Position = 108; continue; }
                if (lightGroup[k].Position == 101) { lightGroup[k].Position = 109; continue; }
                if (lightGroup[k].Position == 102) { lightGroup[k].Position = 110; continue; }
                if (lightGroup[k].Position == 103) { lightGroup[k].Position = 111; continue; }
                if (lightGroup[k].Position == 104) { lightGroup[k].Position = 112; continue; }
                if (lightGroup[k].Position == 105) { lightGroup[k].Position = 113; continue; }
                if (lightGroup[k].Position == 106) { lightGroup[k].Position = 114; continue; }
                if (lightGroup[k].Position == 107) { lightGroup[k].Position = 115; continue; }

                //左圆钮
                if (lightGroup[k].Position == 108) { lightGroup[k].Position = 100; continue; }
                if (lightGroup[k].Position == 109) { lightGroup[k].Position = 101; continue; }
                if (lightGroup[k].Position == 110) { lightGroup[k].Position = 102; continue; }
                if (lightGroup[k].Position == 111) { lightGroup[k].Position = 103; continue; }
                if (lightGroup[k].Position == 112) { lightGroup[k].Position = 104; continue; }
                if (lightGroup[k].Position == 113) { lightGroup[k].Position = 105; continue; }
                if (lightGroup[k].Position == 114) { lightGroup[k].Position = 106; continue; }
                if (lightGroup[k].Position == 115) { lightGroup[k].Position = 107; continue; }

                //下圆钮
                if (lightGroup[k].Position == 116) { lightGroup[k].Position = 123; continue; }
                if (lightGroup[k].Position == 117) { lightGroup[k].Position = 122; continue; }
                if (lightGroup[k].Position == 118) { lightGroup[k].Position = 121; continue; }
                if (lightGroup[k].Position == 119) { lightGroup[k].Position = 120; continue; }
                if (lightGroup[k].Position == 120) { lightGroup[k].Position = 119; continue; }
                if (lightGroup[k].Position == 121) { lightGroup[k].Position = 118; continue; }
                if (lightGroup[k].Position == 122) { lightGroup[k].Position = 117; continue; }
                if (lightGroup[k].Position == 123) { lightGroup[k].Position = 116; continue; }

                //上圆钮
                if (lightGroup[k].Position == 28) { lightGroup[k].Position = 35; continue; }
                if (lightGroup[k].Position == 29) { lightGroup[k].Position = 34; continue; }
                if (lightGroup[k].Position == 30) { lightGroup[k].Position = 33; continue; }
                if (lightGroup[k].Position == 31) { lightGroup[k].Position = 32; continue; }
                if (lightGroup[k].Position == 32) { lightGroup[k].Position = 31; continue; }
                if (lightGroup[k].Position == 33) { lightGroup[k].Position = 30; continue; }
                if (lightGroup[k].Position == 34) { lightGroup[k].Position = 29; continue; }
                if (lightGroup[k].Position == 35) { lightGroup[k].Position = 28; continue; }
            }
            #endregion
            return lightGroup;
        }
