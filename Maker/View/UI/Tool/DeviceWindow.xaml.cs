    ...
    public partial class DeviceWindow : Window
    {
        ...
        public void InitMidiIn()
        {
            ...
            if (position != -1)
            {
                ...
                mw.editUserControl.playuc.ip = new UI.PlayUserControl.InputPort(mw.editUserControl.playuc, "", mw.editUserControl.playuc.inputType, mw.editUserControl.playuc.tbPosition)
                {
