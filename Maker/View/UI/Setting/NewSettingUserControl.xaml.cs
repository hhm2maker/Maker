...
{
    /// <summary>
    /// NewSettingUserControl.xaml 的交互逻辑
    /// </summary>
    public partial class NewSettingUserControl : UserControl
    {
        ...
        {
            wpBig.Visibility = Visibility.Collapsed;
            dpSmall.Visibility = Visibility.Visible;
        }

        private void Image_MouseLeftButtonDown_3(object sender, System.Windows.Input.MouseButtonEventArgs e)
        {
            wpBig.Visibility = Visibility.Visible;
            dpSmall.Visibility = Visibility.Collapsed;
        }
