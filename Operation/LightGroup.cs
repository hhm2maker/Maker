    ...
    public class LightGroup : List<Light>
    {
        ...
        public void HorizontalFlipping()
        {
            ...
            for (int k = 0; k < Count; k++) {
                this[k].Position = newArr[this[k].Position-28];
        }
            //#region
            //for (int k = 0; k < Count; k++)
            //{
            ...
            //    //上圆钮
            //    //if (this[k].Position == 28) { this[k].Position = ; continue; }
            //    //if (this[k].Position == 29) { this[k].Position = ; continue; }
            //    //if (this[k].Position == 30) { this[k].Position = ; continue; }
            //    //if (this[k].Position == 31) { this[k].Position = ; continue; }
            //    //if (this[k].Position == 32) { this[k].Position = ; continue; }
            //    //if (this[k].Position == 33) { this[k].Position = ; continue; }
            //    //if (this[k].Position == 34) { this[k].Position = ; continue; }
            //    //if (this[k].Position == 35) { this[k].Position = ; continue; }
            //    //左下
