...
namespace Operation
{
    public static class IntCollection
    {
        ...
        {
            new List<int>() { -1,108, 109, 110, 111, 112, 113, 114, 115,-1 },
            new List<int>() { 28, 64, 60, 56, 52, 48, 44, 40, 36, 116 },
            new List<int>() { 29, 65, 61, 57, 53, 49, 45, 41, 37, 117 },
            new List<int>() { 30, 66, 62, 58, 54, 50, 46, 42, 38, 118 },
            new List<int>() { 31, 67, 63, 59, 55, 51, 47, 43, 39, 119 },
            new List<int>() { 32, 96, 92, 88, 84, 80, 76, 72, 68, 120 },
            new List<int>() { 33, 97, 93, 89, 85, 81, 77, 73, 69, 121 },
            new List<int>() { 34, 98, 94, 90, 86, 82, 78, 74, 70, 122 },
            new List<int>() { 35, 99, 95, 91, 87, 83, 79, 75, 71, 123 },
            new List<int>() { -1,100, 101, 102, 103, 104, 105, 106, 107 ,-1}
        };
